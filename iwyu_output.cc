...
void ProcessFullUse(OneUse* use,
  ...
  // for anything but placement-new. The 'std::nothrow' and 'std::align_val_t'
  // overloads already need to spell these two values/types, so <new> will be
  // required for them without us doing any magic for new itself.
